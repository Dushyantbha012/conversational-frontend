...
export default function HCSInterviewAssistant() {
  ...
  useEffect(() => {
    ...
    hcsWsRef.current.addStatusChangeListener((status) => {
      ...
      if (status === "ready") {
        ...
        if (hcsWsRef.current) {
          setPreferredLanguage(hcsWsRef.current.getSelectedLanguage());
        }
  ...
  const selectLanguageOption = (language: string) => {
    ...
    if (hcsWsRef.current) {
      hcsWsRef.current.selectLanguage(normalizedLang);
    }
  };
      ...
      <header className="bg-green-700 text-white py-4 px-6">
        ...
        <p className="text-sm opacity-80">
          {preferredLanguage === "english" 
            ? "Haryana Civil Services Interview Preparation" 
            : "हरियाणा सिविल सेवा साक्षात्कार तैयारी"}
        </p>
      </header>
          ...
          <div className="p-6 space-y-4 bg-gray-50 rounded-md">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                {preferredLanguage === "english" 
                  ...
                  : "अपने बारे में विवरण प्रदान करें ताकि HCS साक्षात्कार प्रश्नों को आपके प्रोफ़ाइल के अनुरूप बनाने में मदद मिल सके।"}
              </p>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <button
                ...
                className="flex-1 px-4 py-2 rounded-md font-medium text-white bg-green-700 hover:bg-green-800"
              >
                {preferredLanguage === "english" ? "Start HCS Interview" : "HCS साक्षात्कार शुरू करें"}
              </button>
